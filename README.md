...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ropgadget-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11969&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ropgadget-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ropgadget` can be installed with:

```
conda install ropgadget
```

It is possible to list all of the versions of `ropgadget` available on your platform with:
